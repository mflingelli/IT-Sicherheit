...
\begin{itemize}
  ...
  \only<article>{\item BSI-Video zu Kennwörtern: \href{http://multimedia.gsb.bund.de/BSI/Video/Sicher\_im\_Internet/Passwoerter.mp4}{http://multimedia.gsb.bund.de/BSI/Video/Sicher\_im\_Internet\-/Passwoerter.mp4}}
\end{itemize}
