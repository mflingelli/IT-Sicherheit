...
\begin{frame}
\only<presentation>{
	\frametitle{Praxisreport 2021/22 Mittelstand -- IT-Sicherheit}
}
\input{attacks.tikz}
...
\only<article>{
  \begin{thebibliography}{LFVByXX}
    ...
    \bibitem[DSIN]{DSIM} Deutschland sicher im Netz: \textit{DsiN-Praxisreport 2021/22 Mittelstand@IT-Sicherheit}, \href{https://www.sicher-im-netz.de/file/13823/download?token=Z4uX0d1v}{\url{https://www.sicher-im-netz.de/file/13823/download?token=Z4uX0d1v}}, Juni 2022
