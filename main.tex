...
\end{longtable}
\scriptsize{Quelle: \href{https://sec.hpi.de/ilc/statistics}{https://sec.hpi.de/ilc/statistics}, Stand 16.08.2022}
\only<article>{\newline

\normalsize Die Reihenfolge der zehn beliebtesten Kennwörter änderten sich im Vergleich von Januar 2021 zu Januar 2022 nicht. Es gab lediglich Änderungen der Promillewerte in der zweiten Nachkomma\-stelle.}
\end{frame}
...
\only<article>{\subsection{Umsatz Cyber-Verbrechen}}

\begin{frame}
\only<presentation>{
  \frametitle{Umsatz Cyber-Verbrechen}
}
\begin{center}
\input{earnings_cybercrime.tikz}
...
\begin{frame}
\only<presentation>{
  \frametitle{Kriminalität im Internet}
}
\begin{itemize}
  \item Laut Bürgerbefragung zur Cyper-Sicherheit des BSI\only<article>{ (siehe \cite{BSI21a})}: Ein Viertel der Befragten waren Opfer von Kriminalität im Internet
...
\only<article>{
  \begin{thebibliography}{LFVByXX}
    \bibitem[BDV]{BDV} Beirats Digitaler Verbraucherschutz: \textit{Kommunikation über Sicherheit bei Passwörtern}, \href{https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/digitaler_Verbraucherschutz/Beirat_DVS/Handlungsempfehlung_Sicherheit_Passwoerter.pdf?__blob=publicationFile&v=4}{\url{https://www.bsi.bund.de/SharedDocs/Downloads/DE/BSI/digitaler_Verbraucherschutz/Beirat_DVS/Handlungsempfehlung_Sicherheit_Passwoerter.pdf?__blob=publicationFile&v=4}}, Juli 2022
    ...
    \bibitem[BMJV]{BMJV} Bundesministerium der Justiz und für Verbraucherschutz: \textit{Datenschutz-Grundverordnung}, \href{https://www.bmjv.de/DE/Themen/FokusThemen/DSGVO/DSVGO_node.html}{\url{https://www.bmjv.de/DE/Themen/FokusThemen/DSGVO/DSVGO_node.html}}, 25.05.2018
    \bibitem[BS]{BS} Bruce Schneier: \textit{Click here to kill everybody}, 1. Auflage 2019, mitp
    \bibitem[BSI21a]{BSI21a} Bundesamt für Sicherheit in der Informationstechnik: \textit{Digitalbarometer 2021: Bürgerbefragung zur Cyber-Sicherheit -- Kurzbericht zur Studie der Polizeilichen Kriminalprävention der Länder und des Bundes (ProPK) und des Bundesamtes für Sicherheit in der Informationstechnik (BSI)}, \href{https://www.bsi-fuer-buerger.de}{\url{https://www.bsi-fuer-buerger.de}}, September 2021
    \bibitem[BSI21b]{BSI21b} Bundesamt für Sicherheit in der Informationstechnik: \textit{Verbraucherinnen und Verbraucher}, \href{https://www.bsi-fuer-buerger.de}{\url{https://www.bsi-fuer-buerger.de}}, 27.05.2021
