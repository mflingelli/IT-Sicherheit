...
\begin{itemize}
	...
	\item Trojanische Pferde (oder auch Backdoors) führen auf einem Rechner eine verborgene Funktion aus; meistens um Daten auszuspionieren.
		\only<article>{
		\begin{itemize}
			\item Derzeit die derzeit zerstörerischste Schadsoftware laut US-CERT\footnote{CERT: Abkürzung für \glqq Computer Emergency Response Team\grqq}
...
\begin{itemize}
	...
	\item Süddeutsche Zeitung berichtet über einen Förster, der auf einm Gebrauchtlaptop der Bundeswehr Pläne für den Raketenwerfer \glqq Mars\grqq\ fand
